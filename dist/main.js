...
const pageLoad = () => {
    ...
    if ((0,_update_data__WEBPACK_IMPORTED_MODULE_1__.checkLocalStorage)()) {
        let displayProjectList = (0,_objects__WEBPACK_IMPORTED_MODULE_0__.projectList)();
        let storedValues = JSON.parse(localStorage.getItem('userProjects'));
        let newProject = (0,_objects__WEBPACK_IMPORTED_MODULE_0__.project)(storedValues['projectname']);
...
const todoTask = (title, dueDate=(0,date_fns_endOfToday__WEBPACK_IMPORTED_MODULE_0__["default"])(), description='', priority=undefined) => {
...
const createTestData = () => {
    const testProjectList1 = (0,_objects__WEBPACK_IMPORTED_MODULE_0__.projectList)();
