...
/* harmony export */   "editLocationForm": () => (/* binding */ editLocationForm),
...
/* harmony import */ var _update_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./update-data */ "./src/update-data.js");
...
const generateTaskForm = (newProject, currentProjects, existingTask) => {
  ...
  if (existingTask) {
    ...
    submitTask.addEventListener('click', event => {
      let newTask = (0,_objects__WEBPACK_IMPORTED_MODULE_0__.todoTask)(taskTitle.value);
      if (taskDueDate.value) {
        newTask.setDueDate(taskDueDate.value);
      }
      newProject.addTask(newTask);
      (0,_landing_page__WEBPACK_IMPORTED_MODULE_1__.updateProjectDisplay)(newProject, currentProjects);
    });
  }
...
const editProjectForm = (userProject, currentProjectList) => {
  ...
  updateProjectButton.addEventListener('click', () => {
    ...
    (0,_landing_page__WEBPACK_IMPORTED_MODULE_1__.updateProjectDisplay)(userProject, currentProjectList);
    (0,_landing_page__WEBPACK_IMPORTED_MODULE_1__.updateProjectList)(currentProjectList);
  });
  newProjectForm.append(projectTitleLabel, projectTitleInput, updateProjectButton);
  return newProjectForm;
};
const editLocationForm = function () {
  let currentLocation = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (0,_update_data__WEBPACK_IMPORTED_MODULE_2__.getWeatherFromStorage)();
  ...
  updateLocationButton.addEventListener('click', () => {
    (0,_update_data__WEBPACK_IMPORTED_MODULE_2__.updateWeather)(locationInput.value);
    (0,_landing_page__WEBPACK_IMPORTED_MODULE_1__.generateInfoPane)();
  });
...
/* harmony export */   "generateInfoPane": () => (/* binding */ generateInfoPane),
/* harmony export */   "pageLoad": () => (/* binding */ pageLoad),
/* harmony export */   "updateProjectDisplay": () => (/* binding */ updateProjectDisplay),
/* harmony export */   "updateProjectList": () => (/* binding */ updateProjectList)
/* harmony export */ });
/* harmony import */ var _objects__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./objects */ "./src/objects.js");
/* harmony import */ var _update_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./update-data */ "./src/update-data.js");
...
const pageLoad = () => {
  ...
  if (!(0,_update_data__WEBPACK_IMPORTED_MODULE_1__.checkLocalStorage)()) {
    (0,_update_data__WEBPACK_IMPORTED_MODULE_1__.generateDefaultProject)();
  }
  let currentUser = localStorage.getItem('user');
  let displayProjectList = (0,_update_data__WEBPACK_IMPORTED_MODULE_1__.buildProjectsFromJSON)(JSON.parse(localStorage.getItem('userProjectList')), currentUser);
...
const updateProjectDisplay = (userProject, currentProjects) => {
  ...
  (0,_update_data__WEBPACK_IMPORTED_MODULE_1__.updateLocalStorage)(currentProjects);
  if (userProject) {
    ...
    projectDisplay.appendChild((0,_forms__WEBPACK_IMPORTED_MODULE_2__.generateTaskForm)(userProject, currentProjects));
  } else {
  ...
  projectNameEdit.addEventListener('click', () => {
    ...
    projectHeader.append((0,_forms__WEBPACK_IMPORTED_MODULE_2__.editProjectForm)(userProject, currentProjects));
  });
...
const updateProjectList = currentProjects => {
  ...
  addNewProjectButton.addEventListener('click', () => {
    projectListContainer.append((0,_forms__WEBPACK_IMPORTED_MODULE_2__.editProjectForm)((0,_update_data__WEBPACK_IMPORTED_MODULE_1__.generateDefaultProject)(currentProjects), currentProjects));
...
const generateInfoPane = async () => {
  ...
  let weatherData = await (0,_weather__WEBPACK_IMPORTED_MODULE_3__.generateWeatherObject)((0,_update_data__WEBPACK_IMPORTED_MODULE_1__.getWeatherFromStorage)());
  ...
  weatherLocationEdit.addEventListener('click', () => {
    ...
    infoPane.append((0,_forms__WEBPACK_IMPORTED_MODULE_2__.editLocationForm)());
  });
...
const todoTask = function (title) {
  let dueDate = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns_endOfToday__WEBPACK_IMPORTED_MODULE_1__["default"])(), 'yyyy-MM-dd');
  let description = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
  let priority = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : undefined;
  let _description = description;
  let _dueDate = (0,date_fns_parseISO__WEBPACK_IMPORTED_MODULE_2__["default"])(dueDate);
  ...
  const getDueDate = () => (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(_dueDate, 'MMM dd, yyyy (ccc)');
  const setDueDate = date => _dueDate = (0,date_fns_parseISO__WEBPACK_IMPORTED_MODULE_2__["default"])(date);
  const toJSON = () => {
    return {
      taskTitle: _title,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "buildProjectsFromJSON": () => (/* binding */ buildProjectsFromJSON),
/* harmony export */   "checkLocalStorage": () => (/* binding */ checkLocalStorage),
/* harmony export */   "createTestData": () => (/* binding */ createTestData),
/* harmony export */   "generateDefaultProject": () => (/* binding */ generateDefaultProject),
/* harmony export */   "getWeatherFromStorage": () => (/* binding */ getWeatherFromStorage),
...
const checkLocalStorage = function () {
  let param = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'userProjectList';
...
const generateDefaultProject = userProjectList => {
  ...
  if (!userProjectList) {
    ...
    const newProjectList = (0,_objects__WEBPACK_IMPORTED_MODULE_0__.projectList)(username);
...
const buildProjectsFromJSON = (projectListJSON, user) => {
  let newProjectList = (0,_objects__WEBPACK_IMPORTED_MODULE_0__.projectList)(user);
  if (projectListJSON.length > 0) {
    for (let i in projectListJSON) {
      let newProject = (0,_objects__WEBPACK_IMPORTED_MODULE_0__.project)(projectListJSON[i].projectname);
      let newTasks = projectListJSON[i].tasks;
      for (let j in newTasks) {
        newProject.addTask((0,_objects__WEBPACK_IMPORTED_MODULE_0__.todoTask)(newTasks[j].taskTitle, newTasks[j].taskDueDate, newTasks[j].taskDescription, newTasks[j].taskPriority));
      }
...
const createTestData = () => {
  const testProjectList1 = (0,_objects__WEBPACK_IMPORTED_MODULE_0__.projectList)('Test User');
  const testProject1 = (0,_objects__WEBPACK_IMPORTED_MODULE_0__.project)('Test Project 1');
  const testProject2 = (0,_objects__WEBPACK_IMPORTED_MODULE_0__.project)('Test Project 2');
  const testTask1 = (0,_objects__WEBPACK_IMPORTED_MODULE_0__.todoTask)('Task One', '', 'test description', 1);
  testTask1.setDueDate('2000-04-21');
  const testTask2 = (0,_objects__WEBPACK_IMPORTED_MODULE_0__.todoTask)('Task Two');
  testTask2.setDueDate('1980-11-03');
  testTask2.setDescription('description test');
  testTask2.setPriority(1);
  testTask2.setCompletion();
  const testTask3 = (0,_objects__WEBPACK_IMPORTED_MODULE_0__.todoTask)('Task Three');
...
const updateWeather = function () {
  let location = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'Los Angeles';
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "generateWeatherObject": () => (/* binding */ generateWeatherObject)
/* harmony export */ });
